	...
	<div class="row">
		...
		<div class="col-lg-8 col-md-8 col-sm-8">
			<div class="product-options">
				...
				<h1 class="product-title">Рубашка свободного кроя NNedre</h1>
				...
				<div class="product-color"> <!-- Добавить класс error если цвет не выбран -->
					...
					<ul class="colors">
						...
						<li class="selected"><a href="#" class="color-02"></a></li>
				...
				<div class="product-brand">
					...
					<a href="#"><img src="https://i.imgur.com/6MQzLkT.png" width="166" height="38" alt=""/></a>
				</div>
