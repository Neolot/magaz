...
function(){if(jQuery&&jQuery.fn&&jQuery.fn.select2&&jQuery.fn.select2.amd)var e=jQuery.fn.select2.amd;e.define("select2/i18n/ru",[],function(){function e(e,t,i,s){return e%10<5&&e%10>0&&e%100<5||e%100>20?e%10>1?i:t:s}return{errorLoading:function(){return"Невозможно загрузить результаты"},inputTooLong:function(t){var i=t.input.length-t.maximum,s="Пожалуйста, введите на "+i+" символ";return s+=e(i,"","a","ов"),s+=" меньше"},inputTooShort:function(t){var i=t.minimum-t.input.length,s="Пожалуйста, введите еще хотя бы "+i+" символ";return s+=e(i,"","a","ов")},loadingMore:function(){return"Загрузка данных…"},maximumSelected:function(t){var i="Вы можете выбрать не более "+t.maximum+" элемент";return i+=e(t.maximum,"","a","ов")},noResults:function(){return"Совпадений не найдено"},searching:function(){return"Поиск…"}}}),e.define,e.require}(),function(e){e(function(){function t(t){var i=t.data("owlCarousel"),s=i.$element[0],n=e(".owl-item:not(.cloned)",s).length;e.each(i.options.responsive,function(t,i){v>=t&&(n<=i.items?e(".owl-nav",s).hide():e(".owl-nav",s).show())})}function i(t,i){t<=i.tabletLandscape?e(".nav-special",c).detach().insertBefore(".navs",c):e(".nav-special",c).detach().insertAfter(".navs",c)}function s(t){t.each(function(){var t=e(this)[0].getBoundingClientRect().width;e(".quickview",this).width(t-4).css("margin-left",-((t-4)/2+1)+"px")})}function n(t,i){var s=e("#cart .item"),n=0;s.each(function(){console.log(this);var t=e("input",this).attr("data-price")*e("input",this).val();console.log(t),n+=t}),i&&(n+=parseInt(i)),t.text(number_format(n,0,","," "))}function o(t){var i=e("#cart .item");t.text(i.length)}function a(){var t=0;e("#cart .cart-title, #cart .cart-bottom").each(function(){t+=e(this).outerHeight(!0)}),e("#cart .cart-content").height(e("#cart").height()-t-20)}function r(){v>b.mobilePortrait&&e(".news-list .news-item",m).each(function(){var t=e("img",this).height();e(".news-item-text").css("max-height",t)})}function l(){v<=b.tabletPortrait?e("#account-orders .section-table-row > div").each(function(){var t=e(this).data("title");e(this).not(":has(span)").prepend("<span>"+t+"</span>")}):e("#account-orders .section-table-row > div").each(function(){e(this).has("span").find("span").remove()})}var c=e("#navigation"),d=e(".nav-root > li",c),h=e("#site-content"),u=e("#loop",h),p=e("#filters"),f=e("#categorynav-mobile"),g=e(".checkout-form"),m=e(".news");e.extend(verge);var v=e.viewport().width,b={screen:1599,laptopWide:1399,laptop:1199,tabletLandscape:991,tabletPortrait:767,mobileLandscape:640,mobilePortrait:480};if(isMobile.any()&&e("body").addClass(isMobile.any()[0]),e("#product-sliders .slider1 .carousel-wrapper").length){t(e("#product-sliders .slider1 .carousel-wrapper").owlCarousel({loop:!0,navText:[],smartSpeed:500,responsiveClass:!0,nav:!0,dots:!1,responsive:{0:{items:1},768:{items:2,margin:134},990:{items:3,margin:63},1200:{items:4,margin:32}}}))}if(e("#product-sliders .slider2 .carousel-wrapper").length){t(e("#product-sliders .slider2 .carousel-wrapper").owlCarousel({loop:!0,navText:[],smartSpeed:500,responsiveClass:!0,nav:!0,dots:!1,responsive:{0:{items:1},640:{items:2,margin:27},768:{items:3,margin:67},990:{items:5,margin:12},1200:{items:6,margin:17}}}))}if(e("#site-footer .carousel-wrapper").length){t(e("#site-footer .carousel-wrapper").owlCarousel({loop:!0,navText:[],smartSpeed:500,responsiveClass:!0,nav:!0,dots:!1,responsive:{0:{items:1},640:{items:2,margin:27},768:{items:3,margin:67},990:{items:5,margin:12},1200:{items:6,margin:17}}}))}i(v,b),s(e(".item-thumb-wrapper, .article .image, .page .image")),v<=b.tabletLandscape&&e(".product-additional",h).detach().appendTo(".product-container",h),v<=b.tabletPortrait&&p.detach().appendTo("body"),e(".categorynav-mobile-filters a",f).click(function(){p.toggleClass("open")}),v<=b.tabletPortrait&&e("#sort-dropdown").detach().appendTo("body"),e(".categorynav-mobile-sort a",f).click(function(){e("#sort-dropdown").toggleClass("open")}),e(window).on("orientationchange",function(){v=e.viewport().width,i(v,b),s(e(".item-thumb-wrapper, .article .image, .page .image")),v<=b.tabletPortrait?p.detach().appendTo("body"):p.detach().appendTo("#filters_home"),v<=b.tabletLandscape?e(".product-additional",h).detach().appendTo(".product-container",h):e(".product-additional",h).detach().appendTo("#additional_home"),a(),r(),l()}),e(window).click(function(){c.removeClass("mobile-menu"),d.removeClass("active"),p.removeClass("open"),e("#sort-dropdown").removeClass("open")}),c.click(function(e){e.stopPropagation()}),p.click(function(e){e.stopPropagation()}),e("#sort-dropdown").click(function(e){e.stopPropagation()}),e(".categorynav-mobile-filters a, .categorynav-mobile-sort a",f).click(function(e){e.stopPropagation()}),e(".menu-link",c).click(function(){c.toggleClass("mobile-menu")}),d.click(function(){e(this).toggleClass("active"),d.not(e(this)).removeClass("active")}),e(".searchline-nav input",c).focusin(function(){e(this).closest("form").addClass("active")}),e(".searchline-nav input",c).focusout(function(){e(this).closest("form").removeClass("active")}),e("#filters").on("click",".filter-close",function(){e(this).closest(".filter").removeClass("open")}),v<=b.tabletPortrait&&u.attr("data-columns",3),v<=b.mobileLandscape&&u.attr("data-columns",2),e(".viewmode-3col",h).click(function(){e(this).hasClass("active")||e(this).addClass("active").siblings("a").removeClass("active"),3!==u.attr("data-columns")&&e("> .row",u).animate({opacity:0},300,function(){v>b.laptop?e("> div",this).removeClass("col-lg-6").addClass("col-lg-8"):v>b.tabletLandscape&&e("> div",this).removeClass("col-md-6").addClass("col-md-8"),u.attr("data-columns",3),s(e(".item-thumb-wrapper",u))}).animate({opacity:1},300)}),e(".viewmode-4col",h).click(function(){e(this).hasClass("active")||e(this).addClass("active").siblings("a").removeClass("active"),4!==u.attr("data-columns")&&e("> .row",u).animate({opacity:0},300,function(){v>b.laptop?e("> div",this).removeClass("col-lg-8").addClass("col-lg-6"):v>b.tabletLandscape&&e("> div",this).removeClass("col-md-8").addClass("col-md-6"),u.attr("data-columns",4),s(e(".item-thumb-wrapper",u))}).animate({opacity:1},300)}),e(".categorynav-mobile-view a",f).click(function(){2==e(this).attr("data-columns")?e(this).attr("data-columns",1):e(this).attr("data-columns",2);var t=e(this).attr("data-columns");e("> .row",u).animate({opacity:0},300,function(){u.attr("data-columns",t),s(e(".item-thumb-wrapper",u))}).animate({opacity:1},300)}),e("#cart-link").click(function(){e("body").addClass("cart-open no-scroll").append('<div class="fancybox-overlay fancybox-overlay-fixed" style="display: block;"/>').on("click",".fancybox-overlay",function(){0==e(this).find("#quickorder").length&&(e("body").removeClass("cart-open no-scroll"),e(".fancybox-overlay").remove())})}),e("#cart").on("click",".close",function(){e("body").removeClass("cart-open no-scroll"),e(".fancybox-overlay").remove()}),e("#cart").on("click",".cart-title-mini",function(){e("body").addClass("cart-open")});var _=e("#cart .cart-title-summ span, #cart .cart-summary-summ span"),y=e("#cart .cart-title-quantity");e("#cart .item").each(function(){var t=e(this).find(".item-quantity"),i=e("input",t).val();t.on("click",".item-quantity-minus",function(){i>1&&(i--,e("input",t).val(i),n(_))}),t.on("click",".item-quantity-plus",function(){i++,e("input",t).val(i),n(_)}),t.on("change","input",function(){i=e("input",t).val(),n(_)})}).find(".item-remove").each(function(){e(this).click(function(){e(this).closest(".item").fadeOut(function(){e(this).remove(),n(_),o(y)})})}),a(),e("#cart .cart-content").mCustomScrollbar();var w=e("#cart .cart-shipment");e('.checkout-form select[name="city"]').each(function(){e(this).select2({language:"ru"})}),e('.checkout-form select[name="shipping_method"]').styler({onFormStyled:function(){e('.checkout-form select[name="shipping_method"]').siblings(".jq-selectbox__dropdown").find("li").click(function(){var t=e(this).attr("data-shipment"),i=e(this).attr("data-value");w.find(".shipment span div").text(i),w.find(".price div").text(t),w.addClass("active"),n(_,t)})}});var x=e("#cart .promocode");e("button",x).click(function(){if(""!==e("input",x).val()){var t=e(this);t.find("span").text("Промокод активирован"),t.attr("disabled","disabled"),x.addClass("done"),setTimeout(function(){e("input",x).val(""),t.find("span").text("Активировать"),t.removeAttr("disabled"),x.removeClass("done")},2e3)}}),e(".popup").fancybox({padding:0,closeBtn:!1,beforeShow:function(){e("#qv-gallery").cycle({autoHeight:"container",fx:"fade",timeout:0,pager:"#qv-gallery-pager",pagerTemplate:'<a href="javascript:void(0);"><img src="{{src}}" width="48" height="72"></a>',log:!1}),e('.login input[type="checkbox"]').styler(),e(".login .form .wrapper").each(function(t,i){if(e(C,i).length>0){var s=e(C,i).attr("placeholder");e(i).append('<span class="placeholder">'+s+"</span>"),e(C,i).focusin(function(){e(i).addClass("active").removeClass("invalid"),""==e(i).find("input").val()&&e(i).find("input").val("")}).focusout(function(){e(i).removeClass("active"),""==e(i).find("input").val()&&e(i).find("input").val("")})}})},afterShow:function(){e('input[type="tel"]').mask("+7 (999) 999-99-99")}}),e(document).on("click","#fancybox-close",function(){e.fancybox.close()}).on("click","#login .section-lock",function(){e("#login .section-wrapper").removeClass("open"),e(this).next(".section-wrapper").addClass("open"),e.fancybox.update()}).on("cycle-initialized","#qv-gallery",function(){e.fancybox.update()}),e("#product-gallery").cycle({slides:"> a",autoHeight:"container",speed:200,fx:"fade",timeout:0,swipe:!0,swipeFx:"scrollHorz",pager:"#product-gallery-pager",pagerTemplate:"",log:!1}),e('a[rel="product-gallery"]').iLightBox(),e(".item-thumb-wrapper").each(function(){e("img",this).length<2&&e(this).addClass("noswap")}),e('input[type="tel"]').mask("+7 (999) 999-99-99"),e("#sliding-button, #sliding-button-close").click(function(){e("#sliding-wrapper").toggleClass("open")}),e('a[href^="#"]').bind("click.smoothscroll",function(t){if(t.preventDefault(),this.hash){var i=this.hash,s=e(i);e("html, body").stop().animate({scrollTop:s.offset().top-40},900,"swing")}}),e('.sort-dropdown input[type="radio"], #filters .filter input[type="checkbox"], .checkout-form input, .account .section-data input[type="checkbox"], .account .section-data input[type="radio"]').styler(),e(".account .section-data select").each(function(){e(this).select2({language:"ru"})}),e(".hasdropdown a").click(function(){e(this).parent().toggleClass("open")}),e("html").click(function(){e(".hasdropdown, .hasdropdown-select").removeClass("open")}),e(".hasdropdown, .hasdropdown-select").click(function(e){e.stopPropagation()}),e(".hasdropdown-select").each(function(t,i){e(".dropdown li",i).hasClass("selected")&&e("> a",i).text(e(".dropdown li.selected",i).text()),e(".dropdown li",i).click(function(){e(i).attr("data-selected",e(this).text()),e("> a",i).text(e(this).text()),e("html").trigger("click")})}),e(".filter .filter-lock",p).click(function(){e(this).parent().toggleClass("open")}),e(".filter-range .filter-price-range",p).ionRangeSlider({type:"double",hide_min_max:!0,hide_from_to:!0,onStart:function(t){e(".filter-price-from",p).val(t.from),e(".filter-price-to",p).val(t.to)},onChange:function(t){e(".filter-price-from",p).val(t.from),e(".filter-price-to",p).val(t.to)}});var C='input[type="text"], input[type="email"], input[type="tel"], input[type="password"]';e(".wrapper",g).each(function(t,i){if(e(C,i).length>0){var s=e(C,i).attr("placeholder");e(i).append('<span class="placeholder">'+s+"</span>"),e(C,i).focusin(function(){e(i).addClass("active").removeClass("invalid"),""==e(i).find("input").val()&&e(i).find("input").val("")}).focusout(function(){e(i).removeClass("active"),""==e(i).find("input").val()&&e(i).find("input").val("")})}}),e(".account .wrapper").each(function(t,i){if(e(C,i).length>0){var s=e(C,i).attr("placeholder");e(i).append('<span class="placeholder">'+s+"</span>"),e(C,i).focusin(function(){e(i).addClass("active").removeClass("invalid"),""==e(i).find("input").val()&&e(i).find("input").val("")}).focusout(function(){e(i).removeClass("active"),""==e(i).find("input").val()&&e(i).find("input").val("")})}}),e("ul.tabs").each(function(){e(this).find("li").each(function(t){e(this).click(function(){e(this).addClass("current").siblings().removeClass("current");var i=e(this).parents("div.tabs-wrapper");i.find("div.box").hide(),i.find("div.box:eq("+t+")").fadeToggle("fast"),e(this).closest(".checkout-form").length&&e('.checkout-form select[name="city"]').select2({language:"ru"})})})}),e(".account-orders .section-table-row",h).each(function(){e(".order-details-lock",this).click(function(){e(this).toggleClass("active").next(".account-order-details").toggleClass("open")}),e(".close",this).click(function(){e(this).closest(".account-order-details").removeClass("open").prev(".order-details-lock").removeClass("active")})}),e("#account-address").on("click",".add-address a",function(){e.get("parts/account/address-template.php",function(t){e("#account-address .add-address").before(t),e('.account .section-data input[type="checkbox"], .account .section-data input[type="radio"]').styler(),e(".account .section-data select").each(function(){e(this).select2({language:"ru"})})})}),e("#account-address").on("click",".remove a",function(){e(this).closest(".address-wrapper").fadeOut(400,function(){e(this).remove()})}),e("img",m).load(function(){r()}),l()})}(jQuery);